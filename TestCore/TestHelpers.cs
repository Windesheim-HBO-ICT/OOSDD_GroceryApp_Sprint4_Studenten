...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        public void TestPasswordHelperReturnsFalse()
        {
            // Arrange
            string password = "user3";
            string wrongPasswordHash = "IunRhDKa+fWo8+4/Qfj7Pg==.kDxZnUQHCZun6gLIE6d9oeULLRIuRmxmH2QKJv2IM08=";

            // Act & Assert
            Assert.IsFalse(PasswordHelper.VerifyPassword(password, wrongPasswordHash));
        }
